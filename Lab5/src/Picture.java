...
public class Picture extends JComponent{
	...
	public void paint (Graphics g) {
		...
		g.fillOval(this.xPos + ((this.myWidth/2)/2), this.yPos, (this.myWidth/2), this.myHeight);
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "Wait, hold your horses.");
		...
		// testing the getters for height and width
		JOptionPane.showMessageDialog(null, "Height: " + p.getMyHeight() + "\nWidth: " + p.getMyWidth() + 
				"/nX Position: " + p.getxPos() + "/nY Position: " + p.getyPos());

		p1.setMyWidth(200);
		p1.setMyHeight(78);
		f.setVisible(true);

		JOptionPane.showMessageDialog(null, "Here is a width and height change.");
